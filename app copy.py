...
def main():
    ...
    if page == "🏠 Home":
        ...
        show_recommendations_page(train_df, test_df, df, movie_df)
    
    elif page == "📊 Model Evaluation":
        show_evaluation_page(train_df, test_df)
...
def show_recommendations_page(train_df, test_df, df, movie_df):
...
def show_evaluation_page(train_df, test_df):
...
def show_about_page():
    ...
    - **Pros**: Best personalization, handles sparsity
    - **Cons**: Computationally expensive, requires PySpark
    - **Status**: Available in notebook version
